# Distributed GFS with Multi-Master Architecture (Raft)

## 🚀 Overview
This project implements a **Distributed Google File System (GFS)** with a **multi-master architecture** using the **Raft consensus algorithm**.

Unlike traditional single-master designs, this system enables multiple master nodes to coordinate efficiently, improving **fault tolerance**, **availability**, and **scalability**. Raft ensures **leader election**, **log replication**, and **consistent state management** across masters.
